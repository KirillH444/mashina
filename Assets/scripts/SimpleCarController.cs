...
public class SimpleCarController : MonoBehaviour
{
    ...
    {
        float motor = maxMotorTorque * Input.GetAxis("Vertical") * 1000000;
        ...
        foreach (AxleInfo axleInfo in axleInfos)
        {
            ...
            if (axleInfo.motor)
            {
                ...
                //{
                //    axleInfo.leftWheel.brakeTorque = BreakForce * 100000000;
                //    axleInfo.rightWheel.brakeTorque = BreakForce * 100000000;
                //}
